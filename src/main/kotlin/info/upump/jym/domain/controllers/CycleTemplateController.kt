...
class CycleTemplateController {
    ...
    fun getAllTemplate(): List<Cycle> {
        return cycleTemplateService.getAllTemplateCycle()
    }

    @GetMapping("templates/{cycleId}")
    fun getAllTemplate(@PathVariable cycleId: Long): Cycle {
        return cycleTemplateService.getFullTemplateCycleById(cycleId)
    }
